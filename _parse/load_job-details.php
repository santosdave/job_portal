...
while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
	...
	$sql0 = "SELECT * FROM admin_profile WHERE e_hash='$company_id'";
	...
	while ($row = mysqli_fetch_array($query0, MYSQLI_ASSOC)) {
		...
		while ($row = mysqli_fetch_array($query1, MYSQLI_ASSOC)) {
			...
			$rjoblist .= '<div id="jbd_'.$job_id.'"><div id="" class="profile_widget" style="margin: 5px .9% 5px;"><div class="profile_widget-image">'.$company_pic.'</div><div class="profile_widget-details"><h4>'.$admin_name.'</h3><h4 class="grey-out" style="margin-top: 5px;">'.$company_name.'</h4>';
