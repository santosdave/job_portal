					  ...
					  <div class="widget-content">
						<div class="cf">
						  ...
						  <div id="cpchangelogo" class="widget-user-image hand targetDpLayer" style="left: 45%;" pd-popup-open="changeDp"><?php echo $user_pic;?></div>
							...
							<h3 class="profile-user text-center"><?php echo $admin_name;?> <br>
								<span style="font-size:14px;"><?php echo $company_name;?></span></h3>
								<h3> <span style="font-size:14px;"><?php echo $company_website_url;?></span></h3>
								<h3><button class="btn btn-primary" onclick="admins('<?php echo $log_email;?>')">View profile</button></h3>
							</div>
						  </div>
						</div>
					  </div>
