...
$sql = "SELECT * FROM admin_profile WHERE e_hash='$c_ehash'";
$query = mysqli_query($db_connection, $sql);
while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
	$c_name = $row["admin_name"];
	$b_stream_name = $row["company_name"];
        ...
        <div class="menu-bar2">
            ...
            <div class="menu-container">
                <ul class="menu-list ml-auto">
                    ...
                    <?php echo $jobpost;?>
                    <li>
                        <b><a class="nav-link" href="govt jobs.html">My Jobs <i class="fa fa-briefcase"></i></a></b>
                    </li>
                    <li>
                        <b><a class="nav-link" href="tenders.html">Post Job <i class="fa fa-note"></i></a></b>
                    </li>
                    <li>
                        
                        <b><a class="nav-link" href="sign in.html">Settings <i class="fa fa-gears"></i></a></b>
                    </li>  
